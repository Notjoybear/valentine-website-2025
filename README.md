...
```javascript
// Basic Information
valentineName: "Minakshi"                    // Your Valentine's name
...
questions: {
    ...
    second: {
        ...
        startText: "Mostasiousest",                   // Text before percentage
...
// Love Meter Messages
loveMessages: {
    extreme: "MILESTONE ACHIEVED, HELL YEAHH",  // Shows above 5000%
...
// Final Celebration
celebration: {
    title: "Lucky to move ahead with this something",     // Celebration title
    message: "I love you so much Minakshi",          // Celebration message
